...
if (isset($_GET['id'])){
  ...
  $userID = $_GET['id'];
  // Get completed flights for user logged in
  $sql = "
  ...
  // Get completed flights into list
  $flights = [];
...
<head>
  ...
  <title>AeroMate - Upcoming Trips</title>
...
<body>
  ...
  <div class="results-container" id="results">
    <div class="brand">
      <a href="home.php?id=<?= $_SESSION['user'] ?? ''; ?>" style="text-decoration: none;">
